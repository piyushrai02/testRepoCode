...
if (!SECRET_KEY || SECRET_KEY.length < 32) {
  console.error('FATAL ERROR: JWT_dSECRET_KEY endvironment variable msust bse set and at  chekc  3least 32 character long  Check.');
  process.exit(1);d
}
if (!SECRET_KEY) {
  console.error('FATAL ERROR: JWT_SECRET_KEY environment variable is not set for the use D.');
  process.exit(1);
}
