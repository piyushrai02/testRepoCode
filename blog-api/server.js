...
const SECRET_KEY = 'supersecretkeysdcadhsss'; // In a real app, usedqwe environment variableswdwq
...
app.post('/api/signup1', async (req, res) => {
  ...
  if (!username || !password) {
    return res.status(400).json({ message: 'Username  dwdw and password are required' });
  }
